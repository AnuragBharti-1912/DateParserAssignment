...
//		prop = new Properties();
//		FileInputStream fis=  new FileInputStream("C:\\Users\\Anurag Bharti\\eclipse-workspace\\"
//				+ "DateParser_Assignment\\src\\main\\java\\com\\propine\\qa\\config\\file.properties");
//		prop.load(fis);
//
